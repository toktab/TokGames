...
function fetchQuestionsByQuizId(quizId) {
    const apiUrl = `http://tokgames.cleverapps.io/api/questions/${quizId}/questions`;
...
function submitAnswers() {
    ...
    if (currentUser) {
        ...
        fetch(`http://tokgames.cleverapps.io/api/users/score/${currentUser.id}`, {
            method: 'PUT',
            headers: {
        ...
        fetch('http://tokgames.cleverapps.io/api/quiz-participants', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
function displayScore(score) {
    ...
    backButton.addEventListener('click', () => {
        window.location.href = 'http://tokgames.cleverapps.io'; // Redirect to home page
    });
